...
/**
 * @extends ServiceEntityRepository<UsedVoucher>
 *
...
class UsedVoucherRepository extends ServiceEntityRepository
{
    ...
    public function save(UsedVoucher $entity, bool $flush = false): void
    {
    ...
    public function remove(UsedVoucher $entity, bool $flush = false): void
    {
